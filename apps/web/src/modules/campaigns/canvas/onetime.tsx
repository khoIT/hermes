 ...
 * Audience required. No event trigger. Schedule: send-when-ready / on-date radio.
 */
    ...
    <div style={{ minHeight: '100vh', background: T.n50 }}>
      <div style={{ padding: '24px 40px 0', background: '#fff', borderBottom: `1px solid ${T.n200}` }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, paddingBottom: 16 }}>
          ...
          <TriggerTypeControl value="one-time" onChange={handleTriggerType} />
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', maxWidth: 1400, margin: '0 auto' }}>
        <div style={{ padding: '24px 32px 120px', borderRight: `1px solid ${T.n200}` }}>
          ...
          <CanvasSection>
            <ScheduleBlock triggerType="one-time" />
          </CanvasSection>
          <CanvasSection>
            <ActionBlock />
          </CanvasSection>
      ...
      <div style={{
        ...
        <button style={{ ...btnStyle, background: T.n100, color: T.n700, border: `1px solid ${T.n200}` }}>Test on 100</button>
        <button
